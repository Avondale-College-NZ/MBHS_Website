    ...
    public class SubjectController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Subject != null ? 
                          ...
                          Problem("Entity set 'MBHS_Context.Subject'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("SubjectId,Title,Department")] Subject subject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SubjectId,Title,Department")] Subject subject)
        {
