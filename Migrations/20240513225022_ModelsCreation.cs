    ...
    public partial class ModelsCreation : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubjectTeacher", x => x.SubjectTeacherId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StudentSubjectTeacherId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StudentId = table.Column<int>(type: "int", nullable: false),
                    SubjectTeacherId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentSubjectTeacher", x => x.StudentSubjectTeacherId);
                    table.ForeignKey(
                        name: "FK_StudentSubjectTeacher_Student_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Student",
                        principalColumn: "StudentId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentSubjectTeacher_SubjectTeacher_SubjectTeacherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentSubjectTeacher_StudentId",
                table: "StudentSubjectTeacher",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentSubjectTeacher_SubjectTeacherId",
                table: "StudentSubjectTeacher",
